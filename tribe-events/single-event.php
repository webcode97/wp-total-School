	...
	<div id="post-<?php the_ID(); ?>" <?php post_class('cmsmasters_single_event'); ?>>
		...
		if (has_post_thumbnail()) {
			echo '<div class="cmsmasters_single_event_img">' . 
				tribe_event_featured_image($event_id, 'cmsmasters-full-wide-thumb', false) . 
			'</div>';
		}
		?>
		<div class="cmsmasters_single_event_content_wrapper">
			<div class="cmsmasters_single_event_header clearfix">
				...
				<div class="cmsmasters_single_event_header_right clearfix">
					<div class="tribe-events-back">
						<a class="cmsmasters_theme_icon_date" href="<?php echo esc_url( tribe_get_events_link() ); ?>"> <?php printf( esc_html__( 'All %s', 'total-school' ), $events_label_plural ); ?></a>
					</div>
