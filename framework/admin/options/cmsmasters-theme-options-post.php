...
if (!function_exists('total_school_get_custom_post_meta_fields')) {
function total_school_get_custom_post_meta_fields() {
	$cmsmasters_option = total_school_get_global_options();
	
	
	$cmsmasters_global_blog_post_layout = (isset($cmsmasters_option['total-school' . '_blog_post_layout']) && $cmsmasters_option['total-school' . '_blog_post_layout'] !== '') ? $cmsmasters_option['total-school' . '_blog_post_layout'] : 'r_sidebar';
	...
	$cmsmasters_global_blog_post_title = (isset($cmsmasters_option['total-school' . '_blog_post_title']) && $cmsmasters_option['total-school' . '_blog_post_title'] !== '') ? (($cmsmasters_option['total-school' . '_blog_post_title'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_blog_post_share_box = (isset($cmsmasters_option['total-school' . '_blog_post_share_box']) && $cmsmasters_option['total-school' . '_blog_post_share_box'] !== '') ? (($cmsmasters_option['total-school' . '_blog_post_share_box'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_blog_post_author_box = (isset($cmsmasters_option['total-school' . '_blog_post_author_box']) && $cmsmasters_option['total-school' . '_blog_post_author_box'] !== '') ? (($cmsmasters_option['total-school' . '_blog_post_author_box'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_blog_more_posts_box = (isset($cmsmasters_option['total-school' . '_blog_more_posts_box'])) ? $cmsmasters_option['total-school' . '_blog_more_posts_box'] : 'related';
	...
	$tabs_array['cmsmasters_post'] = array( 
		'label' => esc_html__('Post', 'total-school'), 
	...
	$custom_post_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Don\'t Show Featured Image in Open Post', 'total-school'), 
			'desc'	=> esc_html__('Don\'t Show', 'total-school'), 
		...
		array( 
			'label'	=> esc_html__('Post Image', 'total-school'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Post Gallery', 'total-school'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Audio Links', 'total-school'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Post Title', 'total-school'), 
		...
		array( 
			'label'	=> esc_html__("'Read More' Buttons Text", 'total-school'), 
			'desc'	=> esc_html__("Enter the 'Read More' button text that should be used in you blog shortcode", 'total-school'), 
			'id'	=> $cmsmasters_option_name . 'read_more', 
			'type'	=> 'text', 
			'hide'	=> '', 
			'std'	=> esc_html__('Read More', 'total-school') 
		), 
		array( 
			'id'	=> 'cmsmasters_post', 
			'type'	=> 'tab_finish' 
		...
		array( 
			...
			'desc'	=> '</br>' . esc_html__('Choosing layout with a sidebar please make sure to add widgets in the Appearance - Widgets tab. The empty sidebar won\'t be displayed.', 'total-school'), 
			'id'	=> 'cmsmasters_layout', 
			'type'	=> 'radio_img', 
			'hide'	=> '', 
