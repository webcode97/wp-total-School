...
if (!function_exists('total_school_get_custom_project_meta_fields')) {
function total_school_get_custom_project_meta_fields() {
	...
	$cmsmasters_global_portfolio_project_title = (isset($cmsmasters_option['total-school' . '_portfolio_project_title']) && $cmsmasters_option['total-school' . '_portfolio_project_title'] !== '') ? (($cmsmasters_option['total-school' . '_portfolio_project_title'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_portfolio_project_details_title = (isset($cmsmasters_option['total-school' . '_portfolio_project_details_title']) && $cmsmasters_option['total-school' . '_portfolio_project_details_title'] !== '') ? $cmsmasters_option['total-school' . '_portfolio_project_details_title'] : '';
	
	$cmsmasters_global_portfolio_project_share_box = (isset($cmsmasters_option['total-school' . '_portfolio_project_share_box']) && $cmsmasters_option['total-school' . '_portfolio_project_share_box'] !== '') ? (($cmsmasters_option['total-school' . '_portfolio_project_share_box'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_portfolio_project_author_box = (isset($cmsmasters_option['total-school' . '_portfolio_project_author_box']) && $cmsmasters_option['total-school' . '_portfolio_project_author_box'] !== '') ? (($cmsmasters_option['total-school' . '_portfolio_project_author_box'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_portfolio_more_projects_box = (isset($cmsmasters_option['total-school' . '_portfolio_more_projects_box'])) ? $cmsmasters_option['total-school' . '_portfolio_more_projects_box'] : 'related';
	...
	$tabs_array['cmsmasters_project'] = array( 
		'label' => esc_html__('Project', 'total-school'), 
	...
	$custom_project_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Project Images', 'total-school'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Number of Columns', 'total-school'), 
			'desc'	=> '', 
			...
			'options' => array( 
				'three' => array( 
					'label' => esc_html__('Three', 'total-school'), 
					'value'	=> 'three' 
				), 
				'two' => array( 
					'label' => esc_html__('Two', 'total-school'), 
					'value'	=> 'two' 
				), 
				'one' => array( 
					'label' => esc_html__('One', 'total-school'), 
					'value'	=> 'one' 
				) 
			) 
		),
		...
		array( 
			'label'	=> esc_html__('Video Type', 'total-school'), 
			'desc'	=> '', 
			...
			'options' => array( 
				'embedded' => array( 
					'label' => esc_html__('Embedded (YouTube, Vimeo)', 'total-school'), 
					'value'	=> 'embedded' 
				), 
				'selfhosted' => array( 
					'label' => esc_html__('Self-Hosted', 'total-school'), 
					'value'	=> 'selfhosted' 
				) 
			) 
		), 
		array( 
			'label'	=> esc_html__('Embedded Video Link', 'total-school'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Self-Hosted Video Links', 'total-school'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Title', 'total-school'), 
		...
		array( 
			'label'	=> esc_html__('Project Size', 'total-school'), 
			'desc'	=> esc_html__('Recommended Featured Image dimensions, or other size, with the same ratio', 'total-school') . ' - ', 
		...
		array( 
			'label'	=> esc_html__('Project Details Title', 'total-school'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Info', 'total-school'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__("Project Link Text", 'total-school'), 
			'desc'	=> '', 
			'id'	=> $cmsmasters_option_name . 'link_text', 
			'type'	=> 'text', 
			'hide'	=> '', 
			'std'	=> esc_html__('View Project', 'total-school') 
		), 
		array( 
			'label'	=> esc_html__("Project Link URL", 'total-school'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> '', 
			'desc'	=> esc_html__('Redirect to project link URL instead of opening project page', 'total-school'), 
		...
		array( 
			'label'	=> esc_html__("Project Link Target", 'total-school'), 
			'desc'	=> esc_html__('Open link in a new tab', 'total-school'), 
		...
		array( 
			'label'	=> esc_html__('Project Features 1 Title', 'total-school'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Features 1', 'total-school'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Features 2 Title', 'total-school'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Features 2', 'total-school'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Features 3 Title', 'total-school'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Features 3', 'total-school'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('About Author Box', 'total-school'), 
			'desc'	=> esc_html__('Show', 'total-school'), 
		...
		array( 
			'label'	=> esc_html__('More Posts Box', 'total-school'), 
			'desc'	=> '', 
			...
			'options' => array( 
				'related' => array( 
					'label' => esc_html__('Show Related Tab', 'total-school'), 
					'value'	=> 'related' 
				), 
				'popular' => array( 
					'label' => esc_html__('Show Popular Tab', 'total-school'), 
					'value'	=> 'popular' 
				), 
				'recent' => array( 
					'label' => esc_html__('Show Recent Tab', 'total-school'), 
					'value'	=> 'recent' 
				), 
				'hide' => array( 
					'label' => esc_html__('Hide More Posts Box', 'total-school'), 
					'value'	=> 'hide' 
				) 
			) 
		), 
