...
(function ($) { 
	...
	if ($('input[id^="' + cmsmasters_settings.shortname + '_logo_type"]:checked').val() === 'image') {
		...
		$('#' + cmsmasters_settings.shortname + '_logo_url_overlaps').parents('tr').hide();
		$('#' + cmsmasters_settings.shortname + '_logo_url_retina_overlaps').parents('tr').hide();
	...
	$('input[id^="' + cmsmasters_settings.shortname + '_logo_type"]').on('change', function () { 
		if ($(this).is(':checked') && $(this).val() === 'image') {
			...
			$('#' + cmsmasters_settings.shortname + '_logo_url_overlaps').parents('tr').show();
			$('#' + cmsmasters_settings.shortname + '_logo_url_retina_overlaps').parents('tr').show();
